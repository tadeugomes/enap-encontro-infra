...
resumo = (
    ...
    "marcada heterogeneidade de capacidades estatais subnacionais. O artigo "
    "investiga por que municípios de menor capacidade institucional demandam "
    "mais recursos de reconstrução, se o comportamento efetivo de demanda "
    "supera o rótulo oficial de capacidade na explicação das decisões e em que "
    "medida técnicas de aprendizado de máquina permitem estimar valores de "
    ...
    "da auditoria algorítmica no setor público. Como solução complementar, "
    "disponibiliza-se um motor de previsão da severidade dos desastres, que "
    "antecipa a magnitude provável dos danos de novos eventos."
)
...
intro = [
    ...
    "Do trabalho analítico derivam duas soluções complementares de "
    "inteligência de dados, ambas disponibilizadas como ferramentas de apoio à "
    "decisão. A primeira, um sistema de inteligência para a reconstrução, "
    "constitui o eixo central deste artigo e atua na fase de recuperação, ao "
    "subsidiar a alocação de recursos e a auditoria dos gastos. A segunda, um "
    "motor de previsão da severidade dos desastres, atua nas fases de "
    "prevenção e preparação, ao antecipar a magnitude provável dos danos de um "
    "novo evento. Tomadas em conjunto, as duas soluções percorrem o ciclo de "
    "gestão de riscos estabelecido pela Política Nacional de Proteção e Defesa "
